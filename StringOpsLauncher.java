...
public class StringOpsLauncher {
	...
	public static void main(String [] args) throws FileNotFoundException {
		...
		ops.swapemSort(array); // bubble sort here
		System.out.println("Sorted array:");
		print(array, array.length);	
		
		// Used this to test linear search with getSmallArray. It works.
		ops.linearSearch(array, "dog", 0, 2);

		
		array = getBigArray();
		print(array, 20);
		ops.insertSort(array); // bubble sort here
		print(array, 20);
		
		// Used this to test binary search with getBigArray after sorting.
		ops.binarySearch(array, "bejgjgjgjgin", 0, array.length);
	}
}